...
{
    [SerializeField] public float fSpeed = 0.0f, maxSpeed = 1.0f, revSpeed = 0.2f, rotationSpeed = 2.0f;
    ...
    [SerializeField] private AudioSource idle, move;
    ...
    private void FixedUpdate()
    {
        ...
        if (forwardInput + rotationInput == 0)
        {
            idle.mute = false;
            move.mute = true;
        }
