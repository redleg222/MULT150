...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Debug.Log(Mathf.Round(tank.transform.position.z * 100f) / 100f); 
    ...
    private void UpdateStats()
    {
        ...
        if (!UI.GetComponent<trigger_canvas>().buttonReplay.activeSelf)
        {
    ...
    private void FireMG()
    {
        if (tank.GetComponent<playerTank>().tankOperational && tank.activeSelf)
        {
    ...
    {
        tank.GetComponent<playerTank>().HalfSpeed = false;
    }
